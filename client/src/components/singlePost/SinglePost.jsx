...
export default function SinglePost() {
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`https://startup-budding-backend.onrender.com/api/posts/${post._id}`, {
  ...
  const handleUpdate = async () => {
    try {
      await axios.put(`https://startup-budding-backend.onrender.com/api/posts/${post._id}`, {
